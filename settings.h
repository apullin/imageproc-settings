...
#define AMS_ENC_OFFSET_1        10000
#define LEFT_LEG_FLIP           0       //"forward" reversed for left
...
#define AMS_ENC_OFFSET_0        12110
#define RIGHT_LEG_FLIP          1       //"forward" regular for right
